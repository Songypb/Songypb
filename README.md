...
<!-- 炫酷分隔线 -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&height=100&section=header&text=✨%20Welcome%20✨&fontSize=30&fontAlignY=40" />
</p>
...
> *“Building things that matter, capturing moments that last.”*

I'm a **curious mind** with a passion for:
- 🤖 **AI** — from LLMs to CV, always tinkering  
...
- ✈️ **Travel** — 30+ countries and counting 🌏

---

## 🎯 Interests in Action

| 🤖 AI & ML | 💻 Code | 📊 Ops | 📸 Photo | 🌍 Travel |
|:---:|:---:|:---:|:---:|:---:|
| Transformers | Open Source | Automation | Composition | Culture |
| RAG Systems | Clean Code | KPIs | Golden Hour | Adventure |
| AI Ethics | Debugging | Agile | Post-Processing | Food Trails |

---

## ⚡ Tech Stack (some favs)
...
<!--
**Songypb/Songypb** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
